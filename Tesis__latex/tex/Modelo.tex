...
\begin{figure}[h!]
    ...
    \caption{Diagrama de la estructura general del \jet con region interna y externa. En azul puede verse la vaina o envoltura externa, donde se produce la emisi\'on.}
    \label{fig:mod-1.5}
\end{figure}

\chapter{Conclusiones}\label{cha:conclusiones}
	...
	En particular, para el caso del modelado de Cen~A, se observa que la distribución espectral de energía obtenida presenta la pendiente esperada para una población de electrones relativistas inyectados con un índice espectral $p\simeq2.3$ en el régimen en que el enfriamiento sincrotrón domina las pérdidas de energía.
	...
	También señalamos que el perfil de temperatura de brillo en función de la altura muestra una buena concordancia global con las observaciones del \textit{jet} de Cen A.
...
\item Incorporar la emisión por procesos de IC y SSC, con el objetivo de extender el marco desarrollado hacia una descripción multi-frecuencia más completa y comparar con observaciones en bandas de mayor energía.
\end{itemize}

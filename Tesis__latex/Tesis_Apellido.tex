...
\usepackage{natbib}
\bibliographystyle{biblio/aasjournal}
...
\setlength{\bibsep}{5pt plus 0.5ex}
...
\newcommand{\eg}[1]{{\textcolor{purple} {\bf (EG: #1)}}}
...
%\begin{comment}
\frontmatter
\include{tex/portada}      % Portada 
\clearemptydoublepage
%\include{tex/prefacio}     % Prefacio
%\clearemptydoublepage
%\include{tex/resumen}      % Resumen
%\clearemptydoublepage
%\include{tex/dedicatoria}  % Dedicatoria
%\clearemptydoublepage
%\include{tex/agradecimientos}  %Agradecimientos
%\clearemptydoublepage
\tableofcontents
\include{tex/acronimos}  % Acrónimos
\clearemptydoublepage
\listoffigures
\clearemptydoublepage
%\end{comment}
